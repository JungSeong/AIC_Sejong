...
| `task_board_yaw` | 0.0 | **3.0~3.1415** (평가 시) | 회전각 (rad). Trial 1&2=3.1415(π), Trial 3=3.0. 훈련 시 자유롭게 변경 가능 |
| `task_board_roll` | 0.0 | **0.0 고정** | 평가 시 항상 0 |
| `task_board_pitch` | 0.0 | **0.0 고정** | 평가 시 항상 0 |

> **평가 시 주의:** roll, pitch는 항상 0. yaw는 π 근방(3.0~3.1415)으로 고정 — 0이 아님. 훈련 시에는 어떤 각도든 가능.
